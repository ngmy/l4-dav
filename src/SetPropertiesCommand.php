...
XML);
        ...
        foreach ($properties as $property) {
            ...
            if (empty($namespaces)) {
                $xml->children('DAV:')->set->prop->addChild($property->getName(), (string) $property)->asXML();
                continue;
            }
            ...
            $xml->children('DAV:')->set->prop->addChild($property->getName(), (string) $property, $propertyNamespaceUri);
        }
